...
<body>
	...
	<div class="content">
		<section class="login">
			...
			<!-- <img src="https://edgio.clien.net/F01/12204564/221a6c7811486c.png?scale=width[740],options[limit]"> -->
			<a href="http://localhost:9000/mycgv_jsp/login.do">
				<button type="button" class="btn_style" id="btnLogin" >로그인 페이지 이동</button>
			</a>
		</section>
	</div>
